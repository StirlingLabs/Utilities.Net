/// <auto-generated>
////////////////////////////////////////////////////////////////////////////////
// PACKAGE MedallionPriorityQueue.Inline 1.1.0
//
// The code in this file was AUTO-GENERATED by installing the MedallionPriorityQueue.Inline NuGet package.
// To update, run Update-Package MedallionPriorityQueue.Inline in the NuGet package manager console.
//
...
namespace
#if MedallionPriorityQueue_USE_LOCAL_NAMESPACE
                        StirlingLabs.Utilities.Collections
#else
...
#if MedallionPriorityQueue_PUBLIC
                            public
#else
    internal
#endif
sealed partial class PriorityQueue<T> : ICollection<T>, IReadOnlyCollection<T>
    {
        /// <summary>
        ...
        {
            return this.Count > 0 ? this.FindHelper(item, startIndex: 0) : null;
        }
